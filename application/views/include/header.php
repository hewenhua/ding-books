  ...
  <body>
    <div class="container-narrow">
      <div class="app">
        ...
        <span class='app-username'><?php echo $this->session->userdata('name');?>&nbsp;&nbsp;<span style="font-size:0.32rem;font-family:iconfont" id="user-score"><?php echo isset($user_score)?$user_score:$this->session->userdata('score');?></span><span style="font-size:0.36rem;"><?php if(!empty($this->session->userdata('name'))){echo "&#xe604; ";}?></span></span>
      </div>
      <div class="masthead">
        <div class="head-nav">

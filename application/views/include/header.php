  ...
  <body>
    <div class="container-narrow">
      <div class="app">
        ...
        <span class='app-username'><?php echo $this->session->userdata('name');?>&nbsp;&nbsp;<span style="font-size:0.4rem;font-family:iconfont" id="user-score"><?php echo $this->session->userdata('score');?>&#xe604;</span></span>
      </div>
      <div class="masthead">
        <div class="head-nav">
